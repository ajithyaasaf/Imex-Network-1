    ...
    >
      <div ref={ref} className="relative max-w-7xl mx-auto py-8">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-8 md:pt-16 md:gap-24"
          >
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[hsl(356_84%_51%)] via-[hsl(203_88%_53%)] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
